...
struct FloatingView: View {
    ...
    var body: some View {
        VStack(spacing: 10) {
            HStack(alignment: .center, spacing: 30) {
                Button { } label: {
                    Image(systemName: "gearshape.fill")
                        .frame(width: UIScreen.getWidthby(ratio: 0.1154), height: UIScreen.getHeightby(ratio: 0.0592))
                ...
                ZStack {
                    ...
                    .frame(width: UIScreen.getWidthby(ratio: 0.2820), height: UIScreen.getHeightby(ratio: 0.1303))
            ...
            .frame(width: UIScreen.getWidthby(ratio: 0.26), height: UIScreen.getHeightby(ratio: 0.07))
