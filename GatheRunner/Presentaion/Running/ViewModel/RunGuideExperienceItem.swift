...
class RunGuideExperienceVM: ObservableObject {
    ...
    var getArrsRunGuideExperienceItem: [RunGuideExperienceItem] {
    ...
    private var runGuideExperienceItem = [
        ...
        RunGuideExperienceItem(
            ...
            tag: 4),
        RunGuideExperienceItem(image: "runningGuide_06", title: "", subtitle: "NRC 크루들과 함께하는 러닝 가이드 더 보기", text: "", tag: 5),
    ]
}
